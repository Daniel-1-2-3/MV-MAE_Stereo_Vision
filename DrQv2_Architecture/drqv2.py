...
class DrQV2Agent:
    ...
    def update_critic(self, z, action, reward, discount, z_next, step, obs, update_mvmae: bool):
        ...
        # --- MV-MAE forward + loss (masked encoder + decoder) ---
        recon_loss = None
        if update_mvmae:
    ...
    def update(self, replay_iter, step):
        ...
        # --- Encode obs (unmasked, for critic/actor input) ---
        ...
        # --- Encode next_obs (unmasked, no grad) ---
        with torch.no_grad():
        ...
        # --- Critic update (includes optional MAE update) ---
