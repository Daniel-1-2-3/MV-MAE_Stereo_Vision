...
class StereoPickCube(pick.PandaPickCube):
    ...
    def __init__(  # pylint: disable=non-parent-init-called,super-init-not-called
        ...
        self._floor_geom_id = self._floor_geom
    ...
    def reset(self, rng: jax.Array) -> mjx_env.State:
        ...
        info = {
            ...
            "action_history": jp.zeros((self._config.action_history_length,)),  # Gripper only
        }
        ...
        if self._vision:
            ...
            img_left = jp.asarray(rgb[0][..., :3], dtype=jp.float32) / 255.0 # (H, W, 3)
            img_right = jp.asarray(rgb[1][..., :3], dtype=jp.float32) / 255.0 # (H, W, 3)
    ...
    def step(self, state: mjx_env.State, action: jax.Array) -> mjx_env.State:
        ...
        state.info["prev_action"] = jp.where(newly_reset, jp.zeros(3), state.info["prev_action"])
