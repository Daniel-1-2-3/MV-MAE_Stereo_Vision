...
from Custom_Mujoco_Playground._src.locomotion.op3 import op3_constants as consts


def get_assets() -> Dict[str, bytes]:
  assets = {}
  path = mjx_env.ROOT_PATH / "locomotion" / "op3" / "xmls"
...
class Op3Env(mjx_env.MjxEnv):
  """Base class for OP3 environments."""
