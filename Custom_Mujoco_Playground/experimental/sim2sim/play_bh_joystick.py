...
from Custom_Mujoco_Playground._src.locomotion.berkeley_humanoid import berkeley_humanoid_constants
from Custom_Mujoco_Playground._src.locomotion.berkeley_humanoid.base import get_assets
from Custom_Mujoco_Playground.experimental.sim2sim.gamepad_reader import Gamepad
...
def load_callback(model=None, data=None):
  ...
  model = mujoco.MjModel.from_xml_path(
      berkeley_humanoid_constants.FEET_ONLY_FLAT_TERRAIN_XML.as_posix(),
      assets=get_assets(),
  )
