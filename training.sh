...
apptainer exec --nv \
  ...
  "$IMG" \
  bash -lc 'export MUJOCO_GL=egl; python -m MV_MAE_Implementation.trainer_pipeline --learning_starts 100 --batch_size 64 --buffer_size 200000 --render_mode rgb_array'
