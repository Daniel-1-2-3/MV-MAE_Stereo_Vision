...
class CustomSAC(SAC):
    ...
    def train(self):
        ...
        # Include MV-MAE loss in the total loss
        ...
        print(f'mvmae: {mvmae_loss.item()}, actor: {actor_loss.item()} total_loss: {total_loss.item()}')

        # Backpropagation goes through pipeline of mvmae + actor
        self.actor.optimizer.zero_grad()
        total_loss.backward()
        self.actor.optimizer.step()

        # Dynamically adjusts entropy coef
